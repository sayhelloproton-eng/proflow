...
test("CP-AGT-GW-11 Gateway remains stateless across 0..N Actions in one Worker Turn", async () => {
	...
	assert.doesNotMatch(text, /WorkerTurn(?:Store|Repository|Scheduler)|continueWorker|browserContinue/i);

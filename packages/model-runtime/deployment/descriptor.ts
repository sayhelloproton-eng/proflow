export const descriptor = {
	...
	"configSlots": [
		...
		},
		{
			...
			"required": true,
			"sensitive": true,
			"description": "File containing the dedicated local credential required by Model Runtime callers"
		},
		{
			"key": "providerBaseUrl",
			"type": "url",
		...
		},
		{
			...
			"type": "path",
			"required": true,
			"description": "JSON file containing Deployment-configured FAST/REASON ModelCapabilityProfile values"
		},
		{

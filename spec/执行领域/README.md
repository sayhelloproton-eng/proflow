...
> 受控 real-world Effect、Local/Browser 执行、Result/Evidence、UNKNOWN 与恢复。本目录同时表达 DDD 领域边界和真实工程实现路径。
...
- [execution-contracts](04-模块/execution-contracts/README.md)
- [execution-runtime](04-模块/execution-runtime/README.md)
- [execution-local](04-模块/execution-local/README.md)
- [execution-browser-extension](04-模块/execution-browser-extension/README.md)
